...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, bias=False):
        ...
        self.weight = Parameter(torch.ones(in_features, out_features, dtype=torch.double), requires_grad=True).cuda()
        self.bias = Parameter(torch.ones(1, 1, out_features, dtype=torch.double), requires_grad=True)
